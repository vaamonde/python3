...
## **Playlist do YouTUBE com todos os Vídeos do Python 3 Essentials no GNU/Linux e VSCode:**
🔴 Link da Playlist:

## **🤩🤩 Apresentação do NOVO CURSO GRATUITO de Python 3 Essentials no GNU/Linux e VSCode 🤩🤩**
